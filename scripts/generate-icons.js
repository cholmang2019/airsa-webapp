...
// SVG for Airsa Simorgh Jahan with beautiful golden luxury crest
const createSvg = ({ isMaskable = false } = {}) => {
  ...
  <g transform="translate(${offset}, ${offset}) scale(${scale})">
    ...
    <text x="256" y="420" text-anchor="middle" font-family="sans-serif" font-weight="900" font-size="28" fill="#ffffff" letter-spacing="3">Airsa Simorgh Jahan</text>
  </g>
</svg>`;
};
