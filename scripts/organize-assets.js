...
async function createLocalPlaceholders() {
  const categories = [
    ...
    { dir: 'about', name: 'placeholder-about.webp', label: 'درباره ایرسا سیمرغ جهان', sub: 'About Us' },
  ...
  for (const cat of categories) {
    const svgContent = `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="500" viewBox="0 0 800 500">
      ...
      <text x="400" y="340" fill="#94a3b8" font-family="sans-serif" font-size="14" text-anchor="middle">${cat.sub} Placeholder • Airsa Simorgh Jahan</text>
    </svg>`;
