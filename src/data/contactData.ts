...
export const CONTACT_PAGE_DATA = {
  ...
  directContactCards: [
    ...
    },
    {
      ...
      href: 'mailto:CEO@medixmaster.com?subject=New%20Inquiry%20-%20Airsa%20Simorgh%20Jahan',
    },
  ],
  pillarsSection: {
    badge: 'تعهدات و استانداردهای ایرسا سیمرغ جهان',
    ...
    items: [
      {
        ...
        alt: 'مشاوره تخصصی و تدوین برنامه‌ریزی سفر در ایرسا سیمرغ جهان',
      },
      {
        id: 'coordination',
        number: '۰۲',
      ...
      },
      {
        ...
        alt: 'استانداردهای بین‌المللی و تعهدات حقوقی ایرسا سیمرغ جهان',
      },
    ],
  },
  supportMessage: {
    statement: 'از اولین سؤال تا آخرین مرحله سفر، تیم ایرسا سیمرغ جهان در کنار شماست.',
  ...
  finalCta: {
    ...
    subtitle: 'تیم تخصصی ایرسا سیمرغ جهان در کمترین زمان ممکن درخواست شما را بررسی کرده و پاسخ کامل ارائه می‌دهد.',
