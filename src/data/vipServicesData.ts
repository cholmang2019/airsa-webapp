...
export const VIP_TIMELINE_STEPS: VipTimelineStep[] = [
  ...
  },
  {
    ...
    description: 'استراحت مهمان در سالن اختصاصی همراه با پذیرایی دلپذیر در حالی که کارشناس ایرسا سیمرغ جهان گذرنامه و بار را تحویل می‌گیرد.',
    badge: 'Step 02',
  },
  {
    stepEn: 'Transfer',
...
export const VIP_BRAND_STATEMENT = {
  ...
  subtext: 'تعهد به برتری، دقت در جزئیات نادیدنی و احترام به حریم فردی مهمانان، جوهره بنیادین خدمات VIP ایرسا سیمرغ جهان است.',
  mosaicImages: [
