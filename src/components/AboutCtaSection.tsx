...
import { ABOUT_CTA_DATA, OFFICIAL_CONTACT_URL } from '../data/aboutUsData';
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
            ...
            >
              <span>{ABOUT_CTA_DATA.buttonText}</span>
          ...
          <div className="pt-8 border-t border-white/[0.08] flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-xs sm:text-sm text-slate-400">
            <div className="flex items-center gap-2">
              ...
              <span>مشاوره و نیازسنجی تخصصی</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 className="w-4 h-4 text-amber-400/80 shrink-0" />
              <span>پاسخگویی مستقیم کارشناسان ارشد</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 className="w-4 h-4 text-amber-400/80 shrink-0" />
              <span>حفظ محرمانگی اطلاعات و سوابق</span>
            </div>
          </div>
